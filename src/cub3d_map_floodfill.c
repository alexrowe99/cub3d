...
// /*   Updated: 2023/07/24 15:40:11 by lmells           ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// static t_map_tile	**populate_map_tiles(t_map *data, t_validation *validation)
// {
// 	size_t		i;
// 	t_map_tile	**tiles;

// 	tiles = ft_calloc(data->map_height + 1, sizeof(t_map_tile *));
// 	if (!tiles)
// 	{
// 		validation = add_validation_error(validation,
// 			"Could not initialise map tiles : "MEM_ALLOC);
// 		return (NULL);
// 	}
// 	i = 0;
// 	while (i < data->map_height)
// 	{
// 		tiles[i] = ft_calloc(data->map_width + 1, sizeof(t_map_tile));
// 		if (!tiles[i++])
// 		{
// 			validation = add_validation_error(validation,
// 				"Could not initialise map tiles : "MEM_ALLOC);
...
// 						ERR_INIT_MAP" : multiple player spawn nodes.");
// 					return (false);
// 				}
// 				start->curr_x = x;
// 				start->curr_y = y;
...
// 	start_node.max_x = (*data)->map_width;
// 	start_node.max_y = (*data)->map_height;
...
// 				ERR_INIT_MAP" : no player spawn node found.");
// 		return ;
// 	}
